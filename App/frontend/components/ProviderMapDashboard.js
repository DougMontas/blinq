...
//       // Replace with real-time provider data in production
//       try {
...
//             name: "John Doe",
//             category: "Plumbing",
//             coords: { latitude: location.coords.latitude + 0.01, longitude: location.coords.longitude },
//           },
//           {
//             id: 2,
//             name: "Jane Smith",
//             category: "Electrician",
//             coords: { latitude: location.coords.latitude - 0.01, longitude: location.coords.longitude - 0.01 },
//           },
//         ]);
//       }
//     })();
...
export default function ServiceProMapDashboard() {
  ...
  if (!region) return <ActivityIndicator style={{ marginTop: 100 }} size="large" />;
