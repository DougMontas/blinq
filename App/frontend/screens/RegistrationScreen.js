...
//       <Text style={styles.label}>Select Role</Text>
//       <View style={styles.selectRow}>
//         <TouchableOpacity style={[styles.selectOption, formData.role === "serviceProvider" && styles.selectOptionSelected]} onPress={() => onChange("role", "serviceProvider")}>
//           <Text style={styles.selectOptionText}>Earn with BlinqFix</Text>
//         </TouchableOpacity>
//         <TouchableOpacity style={[styles.selectOption, formData.role === "customer" && styles.selectOptionSelected]} onPress={() => onChange("role", "customer")}>
//           <Text style={styles.selectOptionText}>Book a BlinqFix Job</Text>
//         </TouchableOpacity>
//       </View>
...
//               >
//                 <Text style={styles.selectOptionText}>{tier.replace("_", " ")}</Text>
//               </TouchableOpacity>
//             ))}
//           </View>
//         </>
...
//     if (formData.role === "serviceProvider" && !formData.billingTier.trim()) {
//       Alert.alert("Error", "Please select a billing tier.");
//       return;
//     }
...
//       } else {
//         try {
//           const stripeRes = await api.post("/stripe/create-account-link", {
//             email: formData.email,
//           });
...
//                 onPress={() => onChange("billingTier", tier)}
//               >
//                 <Text style={styles.selectOptionText}>{tier}</Text>
//               </TouchableOpacity>
//             ))}
//           </View>
//         </>
...
//   const onboardWithStripe = async (userId) => {
//     try {
//       const { data } = await api.post("/stripe/create-account", { userId });
//       const { url } = data;
//       if (url) {
//         Alert.alert("Redirecting to Stripe onboarding...");
//         // Note: For web, use Linking.openURL
...
//       const signupRes = await api.post("/auth/register", payload);
//       const userId = signupRes.data?.user?._id || signupRes.data?.id;
...
//           await onboardWithStripe(userId);
//         }
//         navigation.reset({ index: 0, routes: [{ name: "ServiceProviderDashboard" }] });
//       }
//     } catch (err) {
...
//   const onboardWithStripe = async () => {
//     try {
//       const { data } = await api.get("/routes/stripe/onboard");
//       const { url } = data;
//       console.log('url:>>>',url)
//       if (url) {
//         Alert.alert("Redirecting to Stripe onboarding...");
