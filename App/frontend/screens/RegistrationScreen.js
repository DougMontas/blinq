...
//       // If token exists, try to persist to backend too (useful if user revisits this screen while logged in)
...
//       // Also persist the SMS prefs for good measure (now that we have a token)
//       try {
//         await api.put("/users/me/sms-preferences", {
//           jobUpdates: smsJobUpdates,
//           marketing: smsMarketing,
