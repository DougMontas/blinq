...
//           />
//         </View>
//         <Text style={styles.notification}>Emergency Job Awarded. Congrats you got the job. Customer has been notified that you will be in route shortly.</Text>
...
// updated ProviderJobStatus.js to support real-time not-complete modal

// updated ProviderJobStatus.js with working 'Job Not Complete' modal rendering logic
// import React, { useEffect, useState, useRef } from "react";
// import {
//   View,
//   Text,
...
//     socketRef.current.on("jobNotComplete", (payload) => {
//       console.log("⚠️ Received jobNotComplete:", payload);
...
//         <Modal visible={showNotCompleteModal} transparent animationType="fade">
//           <View style={styles.modalOverlay}>
//             <View style={styles.modalContent}>
//               <Text style={styles.title}>Job Marked as Incomplete</Text>
//               <Text style={{ marginVertical: 10 }}>
//                 The customer marked this job as not complete. Please review and address any issues before re-submitting completion.
//               </Text>
//               <CustomButton
//                 title="OK"
...
// updated ProviderJobStatus.js with fallback modal logic for 'Job Not Complete'
// import React, { useEffect, useState, useRef } from "react";
// import {
//   View,
//   Text,
...
//         // ✅ Fallback logic to detect 'not complete' reset
//         if (data.providerCompleted && data.status === "accepted") {
//           setShowNotCompleteModal(true);
//         }
...
//         </View>
//         <Text style={styles.notification}>Emergency Job Awarded. Congrats you got the job. Customer has been notified that you will be in route shortly.</Text>
//         {job.paymentStatus !== "paid" && <Text style={styles.alert}>** Status will update live **</Text>}
//         <JobDetails jobId={jobId} job={job} />
//         {showPhone && job?.customer?.phoneNumber && <Text style={styles.phone}>Customer Phone: {job.customer.phoneNumber}</Text>}
//         <View style={styles.card}>
//           <Text style={styles.title}>Provider Actions</Text>
//           <Text style={{ textAlign: "center", marginBottom: 10 }}>
//             Additional Charge: ${ac.toFixed(2)}
...
//           </Text>
//           <Text style={styles.label}>Step1: Arrival Photo</Text>
//           <CustomButton title="Capture Arrival Photo" onPress={() => pickAndUpload("arrival")} disabled={awaitingAdditional} />
//           <Text style={styles.label}>Step2: Additional Charge</Text>
...
//           <CustomButton title="Submit Additional Charge" onPress={handleUpdateCharge} disabled={awaitingAdditional} />
//           {awaitingAdditional && <Text style={styles.warn}>Awaiting homeowner payment…</Text>}
//           <Text style={styles.label}>Step3: Completion Photo</Text>
//           <CustomButton title="Capture Completion Photo" onPress={() => pickAndUpload("completion")} disabled={awaitingAdditional} />
//           <Text style={styles.label}>Step4: Finalize Job</Text>
//           <CustomButton title="Mark Job Completed" onPress={handleFinalize} disabled={!job.arrivalImage || !job.completionImage} />
//           <CustomButton title={cancelling ? "Cancelling…" : "Cancel Job"} onPress={handleCancelJob} color="red" disabled={cancelling} />
//         </View>
//       </ScrollView>
//       {showNotCompleteModal && (
...
//                 The customer marked this job as not complete. Please review and address any issues before re-submitting completion.
//               </Text>
//               <CustomButton title="OK" onPress={() => setShowNotCompleteModal(false)} />
//             </View>
//           </View>
//         </Modal>
//       )}
...
//   container: { padding: 24, backgroundColor: "#fff" },
//   center: { flex: 1, justifyContent: "center", alignItems: "center" },
//   containerLogo: { justifyContent: "center", alignItems: "center", marginVertical: 40 },
//   alert: { color: "red", textAlign: "center", fontWeight: "bold", marginBottom: 12 },
...
//   warn: { color: "orange", marginTop: 6 },
//   phone: { marginTop: 20, fontSize: 16, fontWeight: "800", color: "red", textAlign: "center" },
//   customButton: { paddingVertical: 12, paddingHorizontal: 16, borderRadius: 6, alignItems: "center", marginVertical: 6 },
...
//         if (data.customerMarkedIncomplete === true && modalDisplayedRef.current === false) {
//           setShowNotCompleteModal(true);
//           modalDisplayedRef.current = true;
//           await api.post(`/jobs/${jobId}/log`, { event: "modal_not_complete_shown", timestamp: new Date().toISOString() });
//         }
...
//         if (data.customerMarkedIncomplete && data.lastNotCompleteAt && (!job?.lastNotCompleteAt || new Date(data.lastNotCompleteAt).getTime() !== new Date(job.lastNotCompleteAt).getTime())) {
//           setShowNotCompleteModal(true);
//           modalDisplayedRef.current = true;
...
//           (!job?.lastNotCompleteAt || new Date(data.lastNotCompleteAt).getTime() !== new Date(job.lastNotCompleteAt).getTime())
//         ) {
//           setShowNotCompleteModal(true);
//           modalDisplayedRef.current = true;
//           try {
...
//   if (!job) {
//     return <Text style={styles.center}>No job found.</Text>;
//   }
...
//               Congrats you got the job. Customer has been notified that you will
//               be in route shortly.
//             </Text>
//           </View>
//         )}
...
// ✅ CLEANED UP: ProviderJobStatus.js - corrected useEffect placement, stable hooks, and null safety
