...
//   //         proofOfInsurance: data.proofOfInsuranceUrl || null,
//   //         contractorAgreement: data.contractorAgreementUrl || null,
//   //         profilePhotoUrl: data.profilePicture || null,
//   //       }));
//   //     } catch (err) {
...
//           contractorAgreement: data.independentContractorAgreement || null,
...
//   //   try {
//   //     const result = await ImagePicker.launchImageLibraryAsync({
//   //       mediaTypes: ImagePicker.MediaType.IMAGE, // ✅ Correct enum usage
//   //       allowsEditing: true,
//   //       quality: 1,
//   //     });
...
//     if (profile.profilePicture && profile.profilePicture.uri) {
//       fd.append("profilePicture", {
//         uri: profile.profilePicture.uri,
//         name: profile.profilePicture.name || "profile.jpg",
//         type: profile.profilePicture.type || "image/jpeg",
...
//         <Image
//           source={{ uri: existing.profilePhotoUrl }}
//           style={{
//             width: 100,
//             height: 100,
//             borderRadius: 50,
...
//         <Text style={s.fileText}>{files.contractorAgreement.name}</Text>
//       )}
...
//       <Text style={s.header}>Complete Your Profile</Text>
//       <Text style={s.label}>About Me</Text>
//       <TextInput style={s.input} multiline value={profile.aboutMe} onChangeText={(t) => setProfile((p) => ({ ...p, aboutMe: t }))} />
//       <Text style={s.label}>Years of Experience</Text>
//       <TextInput style={s.input} keyboardType="number-pad" value={profile.yearsExperience} onChangeText={(t) => setProfile((p) => ({ ...p, yearsExperience: t }))} />
//       <Text style={s.label}>Service Type</Text>
//       <View style={s.pickerWrap}>
//         <Picker selectedValue={profile.serviceType} onValueChange={(v) => setProfile((p) => ({ ...p, serviceType: v }))}>
//           <Picker.Item label="Select…" value="" />
//           {SERVICE_TYPES.map((t) => (
//             <Picker.Item key={t} label={t.replace("_", " ")} value={t} />
//           ))}
...
//       </View>
//       <Text style={s.label}>Business Name</Text>
//       <TextInput style={s.input} value={profile.businessName} onChangeText={(t) => setProfile((p) => ({ ...p, businessName: t }))} />
//       <Text style={s.label}>Address</Text>
//       <TextInput style={s.input} value={profile.address} onChangeText={(t) => setProfile((p) => ({ ...p, address: t }))} />
//       <Text style={s.label}>Extracted Zipcode</Text>
//       <TextInput style={s.input} value={profile.zipcode} editable={false} />
//       <Text style={s.label}>Service Coverage Zipcode</Text>
//       <TextInput style={s.input} value={profile.serviceZipcode} onChangeText={(t) => setProfile((p) => ({ ...p, serviceZipcode: t }))} />
//       <Text style={s.label}>Profile Photo</Text>
//       {profile.profilePicture?.uri ? (
//         <Image source={{ uri: profile.profilePicture.uri }} style={{ width: 100, height: 100, borderRadius: 50, marginBottom: 10 }} />
//       ) : existing.profilePictureUrl ? (
//         <Image source={{ uri: existing.profilePictureUrl }} style={{ width: 100, height: 100, borderRadius: 50, marginBottom: 10 }} />
//       ) : null}
//       <Button title="Upload Profile Photo" onPress={pickProfilePhoto} />
//       {renderLink("W-9", existing.w9)}
//       <Button title="Upload W-9" onPress={() => pickFile("w9")} />
...
//       <Button title="Upload Proof of Insurance" onPress={() => pickFile("proofOfInsurance")} />
//       {files.proofOfInsurance && <Text style={s.fileText}>{files.proofOfInsurance.name}</Text>}
//       {renderLink("Contractor Agreement", existing.independentContractorAgreement)}
//       <Button title="Upload Contractor Agreement" onPress={() => pickFile("independentContractorAgreement")} />
//       {files.independentContractorAgreement && <Text style={s.fileText}>{files.independentContractorAgreement.name}</Text>}
//       <View style={{ marginTop: 12 }}>
//         <Button title="Download Contractor Agreement Template" onPress={downloadAgreementFromAssets} />
//       </View>
//       <View style={{ marginTop: 16 }}>
