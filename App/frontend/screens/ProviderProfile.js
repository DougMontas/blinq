...
//           console.log("⚠️ /users/me/documents failed:", e?.response?.data || e?.message);
//           return null;
//         }),
//         userId ? api.get(`/users/${userId}`).catch((e) => {
//           console.log("⚠️ /users/:id failed:", e?.response?.data || e?.message);
//           return null;
...
//       // If docs include ICA string, ensure viewed flag is true
...
//       });
//     } catch (e) {
//       console.log("❌ hydrateDocsAndPicture error:", e?.response?.data || e?.message);
//     }
//   }, []);
...
export default function ProviderProfile() {
  ...
  const agreementText = `This Independent Contractor Agreement is made between BlinqFix ("Company") and ${
    profile.businessName || "[Contractor Name]"
  } ("Contractor") as of ${new Date().toISOString().split("T")[0]}. [Placeholder summary.] By checking the box, you acknowledge you have read, understood, and agreed to the full terms provided.`;
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.inlineLinksRow}>
                <TouchableOpacity onPress={() => Linking.openURL(W9_URL)} style={styles.linkBtn}>
              ...
              <Text style={styles.helperNote}>
                Upload a clear photo or PDF of your Driver’s License or federal ID. We use this only for identity
                verification and do not share it publicly.
              </Text>
              ...
              {renderUploadSection(
                ...
                "backgroundCheck",
                <ShieldCheck color="#94a3b8" size={24} style={{marginTop: 12}} />
              )}
              <View style={styles.inlineLinksRow}>
                <TouchableOpacity onPress={() => Linking.openURL(BACKGROUND_CHECK_URL)} style={styles.linkBtn}>
                  <ExternalLink color="#60a5fa" size={16} />
                  <Text style={styles.linkText}>Start Background Check</Text>
                </TouchableOpacity>
              </View>
              <Text style={styles.helperNote}>
                Complete your background check online. <Text style={{ fontWeight: "700" }}>The fee will be reimbursed after your first job.</Text>
...
This Independent Contractor Agreement ("Agreement") is made and entered into as of ${new Date()
                  .toISOString()
                  .split("T")[0]} by and between:
