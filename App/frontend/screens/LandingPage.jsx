        ...
        >
          ...
          <View style={[styles.section, styles.heroSection]}>
            ...
            <Text
              style={[
                styles.heroSubtitle,
                { fontSize: clamp(sectionSubtitleSize, 16, 20) },
              ]}
            >
            ...
            <Text
              style={[
                ...
                { fontSize: clamp(sectionSubtitleSize - 2, 14, 18) },
              ]}
            >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.servicesGrid}>
              {services.map((service, index) => (
                <View
                  key={index}
                  style={[styles.serviceCard, { width: twoColWidth }]}
                >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.statsGrid}>
              {stats.map((stat, index) => (
                <View
                  key={index}
                  style={[styles.statCard, { width: twoColWidth }]}
                >
                  <stat.icon
                    color={stat.color}
                    width={statIconSize}
                  ...
                  <Text
                    style={[
                      styles.statValue,
                      {
                        ...
                        lineHeight: Math.round(statValueSize * 1.05),
                      },
                    ]}
                    numberOfLines={1}
