      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.tabsRow}>
          <TouchableOpacity
            ...
            style={[
              styles.tabChip,
              tab === "customer" && styles.tabChipActive,
            ]}
          >
            <Text
              style={[
            ...
            <>
              ...
              <View style={styles.introCard}>
                ...
                >
                  ...
                  <Text style={styles.introText}>
                    Everything you need to know about working as a BlinqFix service
                    professional. Find answers to the most common questions about our
                    platform.
                  </Text>
                </LinearGradient>
              </View>
              ...
              <View style={styles.supportCard}>
                ...
                >
                  ...
                  <Text style={styles.supportText}>
                    ...
                    help service professionals succeed on the platform.
                  </Text>
                  <View style={styles.supportBadge}>
                    <CheckCircle color="#22c55e" size={16} />
                    <Text style={styles.supportBadgeText}>24/7 Support Available</Text>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 20, fontWeight: "bold", color: "#fff", marginLeft: 12 },
  faqItem: {
    marginBottom: 16,
    paddingBottom: 16,
    borderBottomWidth: 1,
  ...
  supportHeader: { flexDirection: "row", alignItems: "center", marginBottom: 12 },
  supportTitle: { fontSize: 20, fontWeight: "bold", color: "#fff", marginLeft: 12 },
  supportText: { fontSize: 16, color: "#e0e7ff", lineHeight: 24, marginBottom: 16 },
  supportBadge: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "rgba(34, 197, 94, 0.2)",
