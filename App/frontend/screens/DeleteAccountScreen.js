          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.warningCard}>
              ...
              >
                ...
                <Text style={styles.warningText}>
                  Emergencies are unpredictable and it's always best to have a plan for them. 
                  But if you must go just remember, you can download the app again, in case you need us.
                </Text>
                <View style={styles.warningBadge}>
                  <Download color="#60a5fa" size={16} />
                  <Text style={styles.warningBadgeText}>Always here when you need us</Text>
                </View>
              </LinearGradient>
            </View>
            ...
            <View style={styles.feedbackCard}>
              ...
              >
                <View style={styles.cardHeader}>
                  ...
                  <Text style={styles.cardTitle}>Why are you deleting your account?</Text>
                </View>
            ...
            <View style={styles.securityNotice}>
              ...
              <Text style={styles.securityText}>
                Your data will be permanently deleted within 30 days as per our privacy policy.
              </Text>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
