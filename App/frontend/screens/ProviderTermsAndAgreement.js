      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <Section title="1. Definitions" icon={BookText}>
            <ListItem>
              “Platform”: The BlinqFix website, mobile app, software, and
              related services.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              “Booking”: A confirmed job request made in the app.
            </ListItem>
          </Section>
          ...
          <Section title="2. Overview and Acceptance" icon={CheckSquare}>
            <Paragraph>
              ...
              any additional posted policies. If you do not agree, do not use
              the Platform.
            </Paragraph>
          </Section>
          ...
          <Section title="3. Account Registration & Eligibility" icon={User}>
            ...
            <Paragraph>
              BlinqFix may refuse access, suspend, or cancel accounts at its
              sole discretion for violations or fraud.
            </Paragraph>
          </Section>
          ...
          <Section title="4. Customer Terms (Homeowners)" icon={Wrench}>
            ...
            <ListItem>
              Provide accurate address, contact, and job details
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              Pricing and fees (including any platform/convenience fee) are
              shown before you confirm. By booking, you authorize payment for
              the shown amounts and any approved add-ons.
            </ListItem>
            <ListItem>
          ...
          <Section title="6. General Rules & Prohibited Uses" icon={Users}>
            <ListItem>
              Do not misuse, reverse engineer, or attack the Platform
            </ListItem>
            <ListItem>
              Do not upload unlawful, harassing, or infringing content
            </ListItem>
          ...
          <Section title="7. Privacy & Security" icon={Lock}>
            <Paragraph>
              ...
              See our Privacy Policy and SMS policy below for details on the
          ...
          <Section title="9. Changes to Terms" icon={FileText}>
            <Paragraph>
              ...
              posted in-app with an effective date. Continued use constitutes
              acceptance.
            </Paragraph>
          </Section>
