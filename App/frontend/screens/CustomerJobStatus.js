...
//nope CustomerJobStatus.js (stable version with preserved styling and fixed logic)
// import React, { useEffect, useState, useRef } from "react";
// import {
//   View,
//   Text,
...
//           <Text style={styles.heading}>Your emergency service pro is now in route</Text>
//           <Text style={{ color: "red", textAlign: "center", marginTop: 10 }}>
//             Make the necessary preparations. Put away pets, ensure gate access, and prepare for all necessary access if needed.
//           </Text>
//           {description && (
//             <>
//               <Text style={styles.sectionTitle}>What’s Covered:</Text>
...
//             <Marker coordinate={jobLocation} title="Customer" />
//             {providerCoords && (
//               <Marker coordinate={providerCoords} title="Service Pro" pinColor="blue" description="Provider's current location" />
//             )}
//             {routeCoords.length === 2 && (
//               <Polyline coordinates={routeCoords} strokeColor="#1976d2" strokeWidth={4} lineCap="round" />
//             )}
//           </MapView>
//         </View>
//       )}

//       {eta && <Text style={{ textAlign: "center", marginBottom: 10 }}>Estimated Arrival: {eta} min</Text>}
...
//       {job.paymentStatus === "awaiting-additional-payment" && (
//         <View style={styles.waiting}>
//           <Text>Additional charge of ${job.additionalCharge.toFixed(2)} pending…</Text>
//           <Text>Convenience fee: ${convFee.toFixed(2)}</Text>
//           <Text>Total due: ${totalDue.toFixed(2)}</Text>
//         </View>
//       )}
