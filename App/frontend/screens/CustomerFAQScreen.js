  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.answer}>
        ...
        is to simplify the process of finding reliable help for your home needs.
      </Text>

      <Text style={styles.question}>How does BlinqFix work?</Text>
      <Text style={styles.answer}>
        After signing up, you can submit a service request detailing the issue.
        BlinqFix then matches you with qualified professionals in your area who
        can address your specific needs.
      </Text>

      <Text style={styles.question}>Which areas does BlinqFix serve?</Text>
      <Text style={styles.answer}>
        Currently, BlinqFix operates in select regions. Please check our website
        or app to see if services are available in your area. (Blinq Rewards)
      </Text>
      ...
      <Text style={styles.answer}>
        ...
        dashboard. Please note our cancellation policy for any applicable fees.
      </Text>
      ...
      <Text style={styles.answer}>
        ...
        market rates in your area. You'll receive a quote before confirming the
        booking.
      </Text>
