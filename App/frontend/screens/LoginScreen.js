    ...
    try {
      ...
      try {
        ...
        if (bootRole === "serviceProvider") {
          target = summary.profileComplete ? "ServiceProviderDashboard" : "ProviderProfile";
        ...
        else if (navigation && typeof navigation.reset === "function") navigation.reset(action);
      } catch {
...
const styles = StyleSheet.create({
  ...
  loginButtonGradient: { flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 18, gap: 12 },
  loginButtonText: { color: "#fff", fontSize: 18, fontWeight: "bold" },
