...
// // ✅ use the shared Provider + navigationRef used across the app
...
// // Small helper to push the decoded role into the AuthContext on boot
...
//       try {
//         if (Platform.OS === "android") {
//           // keep a default channel if you want
//           await Notifications.setNotificationChannelAsync("default", {
//             name: "Default",
//             importance: Notifications.AndroidImportance.MAX,
//             sound: "default",
...
//           // NEW: custom-sound channel (note the *new* id and sound name)
//           await Notifications.setNotificationChannelAsync("job-invites-v2", {
//             name: "Job Invitations",
//             importance: Notifications.AndroidImportance.MAX,
//             sound: "notification", // <-- from assets/notification.mp3 (no extension)
//             vibrationPattern: [0, 300, 200, 300],
//             enableVibrate: true,
//             bypassDnd: true,
//             lockscreenVisibility:
...
//     >
//       <SafeAreaProvider>
//         {/* ✅ Use the shared AuthProvider so screens can `useAuth()` */}
//         <AuthProvider>
...
//                 component={RequestPasswordResetScreen}
//               />
//               <Stack.Screen name="ResetPasswordLost" component={ResetPasswordLost} />
//               <Stack.Screen
//                 name="HandymanCategoryScreen"
//                 component={HandymanCategoryScreen}
//               />
...
//         const isInvite = type.includes("invitation") || type === "teaser";
...
//         } else {
//           console.log("🧭 Navigate: ProviderInvitation", { jobId });
//           navigationRef.current?.navigate("ProviderInvitation", { jobId });
//         }
//       });
